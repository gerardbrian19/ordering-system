<?php
/**
 * Staff HTML shell + sidebar navigation.
...
<head>
    ...
    <title><?= e($pageTitle) ?> — Goldcomm Staff</title>
...
<aside id="staff-sidebar"
       ...
       class="flex items-center gap-3 px-5 py-5 border-b border-white/10 hover:bg-white/5 transition shrink-0">
        ...
        <div>
            <p class="text-white font-bold text-sm leading-tight">
                Gold<span class="text-indigo-400">comm</span>
            </p>
            <p class="text-gray-400 text-xs">Staff Panel</p>
        </div>
    </a>
    ...
    <div class="px-4 py-4 border-t border-white/10 shrink-0">
        <div class="flex items-center gap-3">
            <div class="w-9 h-9 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-full
                        flex items-center justify-center text-white text-sm font-bold shrink-0">
                <?= strtoupper(substr($_SESSION['user_name'] ?? 'S', 0, 1)) ?>
            </div>
            <div class="min-w-0">
                <p class="text-white text-sm font-semibold truncate"><?= e($_SESSION['user_name'] ?? 'Staff') ?></p>
                <p class="text-gray-400 text-xs">Staff Member</p>
            </div>
        </div>
    </div>
</aside>
...
<div class="lg:pl-64 min-h-screen flex flex-col">
    ...
    <!-- Page content starts here — closed by staff_footer.php -->
